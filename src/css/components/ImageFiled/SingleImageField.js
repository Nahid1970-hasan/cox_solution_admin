...
const SingleImageField = ({ defaultFile, setDefaultFile, imageFile, handleImage, defaultImage, editedMaterial, onHide, categoryID, mainImage, setMainImage }) => {
                    ...
                    {defaultFile ? (
                        ...
                        <div>
                            <div className="imageBox">
                                {mainImage?.imagePath ? (
                                    <div>
                                        <img className="object-cover  w-32 h-32" src={mainImage?.imagePath} alt="" />
                                        <button
                                            type="reset"
                                            onClick={(e) => {
